...
var app = new Vue({
  ...
  methods:{
    ...
    showLevelGroupInfo: function(){
      let {levelGroup, dialogFormVisible } = this.loadLevelDialog(this.levelGroup, this.dialogFormVisible);
    ...
    showLevelGroupInfo2: function(){
      let {levelGroup, dialogFormVisible } = this.loadLevelDialog(this.levelGroup2, this.dialogFormVisible2);
      this.levelGroup2 = levelGroup;
      this.dialogFormVisible2 = dialogFormVisible;
    },
    // 级别窗体 loadLevelsDialog
    loadLevelDialog: function(levelGroup, dialogFormVisible){
      // 重置级别变量
      ...
      let llc_index = 0
      for ( var i of levelNameList){
        levelGroup[i] = (levelGroup[i]/ this.levelLetterCount[llc_index] *100).toFixed(2)
        llc_index ++;
      }
    ...
    init: function(){
      ...
      this.levelNum = this.levelNum + '-' + this.letterDb.length
      this.loadLetter()
      this.isPlay = true
    },
    // 重新加载
